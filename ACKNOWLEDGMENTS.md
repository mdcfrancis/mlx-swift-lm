...
- [Michael Francis](https://github.com/mdcfrancis): Added DFlash speculative decoding (tapped-layer drafting, recurrent
  tape rewind, verify kernels ported from [dflash-mlx](https://github.com/bstnxbt/dflash-mlx) by bstnxbt).
